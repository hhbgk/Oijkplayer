...
Java_tv_danmaku_ijk_media_player_IjkMediaPlayer__1setDataSourceFd(JNIEnv *env, jobject thiz, jint fd)
{
    MPTRACE("%s\n", __func__);
    int retval = 0;
    int dupFd = 0;
...
Java_tv_danmaku_ijk_media_player_IjkMediaPlayer__1getPropertyFloat(JNIEnv *env, jobject thiz, jint id, jfloat default_value)
{
...
Java_tv_danmaku_ijk_media_player_IjkMediaPlayer__1setPropertyFloat(JNIEnv *env, jobject thiz, jint id, jfloat value)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
Java_tv_danmaku_ijk_media_player_IjkMediaPlayer__1getPropertyLong(JNIEnv *env, jobject thiz, jint id, jlong default_value)
{
...
JNIEXPORT void JNICALL
Java_tv_danmaku_ijk_media_player_IjkMediaPlayer__1setPropertyLong(JNIEnv *env, jobject thiz, jint id, jlong value)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
